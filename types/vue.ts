...
export interface DefineMixin {
  <Data, Methods, Computed, Props>(
    options?: ThisTypedComponentOptionsWithRecordProps<
      ...
      Props
    >,
  ): Data & Methods & Computed & Props & VueConstructor<Vue>
}
...
export interface DefineComponentWithMixin {
  ...
  <
    ...
    Computed,
    Props,
    Mixin1 extends Record<string, any>,
    Mixin2 extends Record<string, any>,
  >(
    options?: ThisTypedComponentOptionsWithRecordProps<
      Vue,
      Data & Omit<Mixin1 & Mixin2, keyof VueConstructor<Vue>>,
      Methods,
      Computed,
      Props
    > & { mixins: [Mixin1, Mixin2] },
  ): ExtendedVue<Vue, Data, Methods, Computed, Props>
  <Data, Methods, Computed, Props, Mixin extends Record<string, any>>(
    options?: ThisTypedComponentOptionsWithRecordProps<
      Vue,
      Data & Omit<Mixin, keyof VueConstructor<Vue>>,
      Methods,
      Computed,
      Props
    > & { mixins: Mixin[] },
